...
A modern, production-ready marketing website for Sauced, a full-stack footwear and apparel sourcing company. Built with React, TypeScript, Vite, and Tailwind CSS.
...
- 📅 Inline Google Calendar booking integration
...
2. Run: `vercel`
3. Or connect your GitHub repo to [Vercel Dashboard](https://vercel.com)

The project includes `vercel.json` with optimized configuration for SPA routing.
...
See `VERCEL_DEPLOYMENT_CHECKLIST.md` for detailed deployment instructions.
...
This project was migrated from Lovable.dev to work independently. See `cursor-migration.md` for detailed migration information.
...
This is a private repository. For questions or issues, please contact the project maintainers.

---

**Built with ❤️ for Sauced**
